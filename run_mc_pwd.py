...
from models.PWD import RecAdam
...
def main():
    ...
    model_pt = AutoModelForMultipleChoice.from_pretrained(
    ...
    optimizer_grouped_parameters = [
        # Pre-trained weights with weight decay.
        {
            "params": [p for n, p in  model.named_parameters() if
                        not any(nd in n for nd in no_decay) and model_type in n and "pooler" not in n],
            "weight_decay": args.weight_decay,
            "anneal_w": args.recadam_anneal_w,
            "pretrain_params": [p_p for p_n, p_p in model_pt.named_parameters() if
                                not any(nd in p_n for nd in no_decay) and model_type in p_n and "pooler" not in p_n]
        },
        # Newly inited weights with weight decay.
        {
            "params": [p for n, p in  model.named_parameters() if
                        not any(nd in n for nd in no_decay) and (model_type not in n or "pooler" in n)],
            "weight_decay": args.weight_decay,
            "anneal_w": 0.0,
            "pretrain_params": [p_p for p_n, p_p in model_pt.named_parameters() if
                                not any(nd in p_n for nd in no_decay) and (model_type not in p_n or "pooler" in p_n)]
        },
        # Pre-trained weights without weight decay.
        {
            "params": [p for n, p in  model.named_parameters() if
                        any(nd in n for nd in no_decay) and model_type in n and "pooler" not in n],
            "weight_decay": 0.0,
            "anneal_w": args.recadam_anneal_w,
            "pretrain_params": [p_p for p_n, p_p in model_pt.named_parameters() if
                                any(nd in p_n for nd in no_decay) and model_type in p_n and "pooler" not in p_n]
        },
        # Newly inited weights without weight decay.
        {
            "params": [p for n, p in  model.named_parameters() if
                        any(nd in n for nd in no_decay) and (model_type not in n or "pooler" in n)],
            "weight_decay": 0.0,
            "anneal_w": 0.0,
            "pretrain_params": [p_p for p_n, p_p in model_pt.named_parameters() if
                                any(nd in p_n for nd in no_decay) and (model_type not in p_n or "pooler" in p_n)]
        }
    ]
    optimizer = RecAdam(optimizer_grouped_parameters, lr=args.learning_rate,
    ...
    model, model_pt, optimizer, train_dataloader, eval_dataloader = accelerator.prepare(
        model, model_pt, optimizer, train_dataloader, eval_dataloader
    )
