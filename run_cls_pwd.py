...
def main():
    ...
    model_pt = AutoModelForSequenceClassification.from_pretrained(
        ...
        config=config,
        cache_dir="../data/huggingface/models",
    )
    ...
    model, model_pt, optimizer, train_dataloader, eval_dataloader, loss_cls_masked = accelerator.prepare(
        model, model_pt, optimizer, train_dataloader, eval_dataloader, loss_cls_masked
    )
